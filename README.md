...
1 The user, who serves as the treasurer of the commission, saves commission members in the settings panel. </br>2 In the calendar panel, there is a table showing the record of contributions paid throughout the year by each member of the commission. </br>3 In the table, you user mark whether a particular member has paid the contribution for a given month.
